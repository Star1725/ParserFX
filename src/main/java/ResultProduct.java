...
public class ResultProduct extends Product{
    ...
    public ResultProduct(int vendorCode, String brand, String productName, String refForPage, String refForImage, double lowerPrice, double price, int sale, String specAction, int rating, double myLoverPrice, double myPrice, int mySale, double recommendedPrice, int recommendedSale) {
        super(vendorCode, brand, productName, refForPage, refForImage, lowerPrice, price, sale, specAction, rating);
