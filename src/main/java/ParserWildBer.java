...
//
//    public Product getProduct(int marketplaceFlag, String myVendorCodeFromRequest, String category, String brand, String productType, String productModel, List<String> arrayParams, Set myVendorCodes, String specQuerySearch, WebClient webClient){
...
////        product.setMyProductName(ParserHtmlForWildberries.getMyProductsTitle(myPage));
//
...
//        List<Product> productList;
//        Document page;
//        page = SupplierHtmlPage.getPageForUrl(query);
//
//        //получение бренда, артикула, имени товара, ссылки на страницу товара, ссылки на картинкау товара, спец-акции, рейтинга
//        productList = ParserHtmlForWildberries.getCatalogProductsForRequestPage(page, brand);
//        if (productList.size() == 0){
//            return productList;
//        }
